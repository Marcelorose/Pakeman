...
int menuBatalha(Npc &jogador1, Npc &jogador2, int turno, int monstroJ1, int monstroJ2,int atacante, int monstroAtacante) {
	int opcao;
...
void telaBatalha(Npc &jogador1, Npc &jogador2, int turno = 1){
	...
	{
		int opcao = menuBatalha(jogador1, jogador2, turno, 0, 0, 0, 0);
		monstrosHP(opcao, jogador1, jogador2, 0, 0);
	}
